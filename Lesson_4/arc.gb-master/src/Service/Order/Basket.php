...
class Basket
{
    ...
    public function checkout(): void
    {
        ...
        // Здесь должна быть некоторая логика выбора способа платежа, логика получения информации о скидке
        // пользователя, логика получения способа уведомления пользователя о покупке
        ...
        (new CheckoutProcess())->checkoutProcess($basketBuilder, $this->getProductsInfo());
    }
